...
function validateModelProfiles() {
  ...
  for (const profile of ['smoke', 'face_detailer_smoke', 'qwen_edit_smoke', 'photo_lifestyle_v1', 'first_full']) {
    ...
    const mustBeComplete = ['smoke', 'face_detailer_smoke', 'qwen_edit_smoke', 'photo_lifestyle_v1'].includes(profile);
