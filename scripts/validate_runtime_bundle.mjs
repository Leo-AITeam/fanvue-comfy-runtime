...
function validateModelProfiles() {
  ...
  for (const profile of ['smoke', 'face_detailer_smoke', 'qwen_edit_smoke', 'anna_v2_pulid_flux_ref001', 'photo_lifestyle_v1', 'video_lifestyle_v1', 'video_adult_v1', 'first_full']) {
    ...
    const mustBeComplete = ['smoke', 'face_detailer_smoke', 'qwen_edit_smoke', 'anna_v2_pulid_flux_ref001', 'photo_lifestyle_v1', 'video_lifestyle_v1', 'video_adult_v1'].includes(profile);
